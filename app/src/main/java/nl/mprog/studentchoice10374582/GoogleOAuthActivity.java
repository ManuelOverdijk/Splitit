...
/**
 * This is a sample GoogleOAuthActivity that has been extracted from to
    ...
    private void resolveSignInError() {
        if (mGoogleConnectionResult.hasResolution()) {
            try {
                ...
                mGoogleConnectionResult.startResolutionForResult(this, SplitIt.RC_GOOGLE_LOGIN);
    ...
    private void getGoogleOAuthTokenAndLogin() {
        ...
        AsyncTask<Void, Void, String> task = new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    if (!mGoogleIntentInProgress) {
                        ...
                        startActivityForResult(recover, SplitIt.RC_GOOGLE_LOGIN);
                    }
            ...
            protected void onPostExecute(String token) {
                ...
                setResult(SplitIt.RC_GOOGLE_LOGIN, resultIntent);
                finish();
            }
        };
        task.execute();
